...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Future<void> _cargarResumenDashboard() async {
    try {
      ...
      final hasta =
          _pgDate(DateTime(hoy.year, hoy.month, hoy.day).add(const Duration(days: _diasPorVencer)));

      // Stock real: total items por inventario
      final stockRows =
          await _supabase.from('items').select('id_item').eq('id_invent', inv);
      ...
      final porVencerRows = await _supabase
          .from('items')
          .select('id_item, nombre_medicamento, num_lote, fech_venc')
          .eq('id_invent', inv)
          .gte('fech_venc', desde)
          .lte('fech_venc', hasta)
  ...
  void _abrirMedicamentos() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => MedicamentosPage(idInvent: inv)),
    );
  }
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.warning_amber_rounded, color: Color(0xFFFFD166)),
                        ),
                        ...
                        IconButton(
                          ...
                          icon: Icon(Icons.refresh_rounded, color: Colors.white.withOpacity(0.85)),
                          tooltip: "Actualizar",
                        ),
                        IconButton(
                    ...
                    if (_idInventActual == null) ...[
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.check_circle_rounded, color: Colors.white.withOpacity(0.85)),
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) {
                            ...
                            final color = dias <= 7 ? const Color(0xFFEF4444) : const Color(0xFFFFD166);
                            final loteTxt = (it.numLote ?? '').trim().isEmpty ? '—' : it.numLote!.trim();
  ...
  Widget build(BuildContext context) {
    ...
    final stats = <_Stat>[
      _Stat(
        label: "En stock",
        value: _loadingInvent || _loadingResumen ? "..." : _stockCount.toString(),
        icon: Icons.inventory_2_rounded,
        onTap: _abrirMedicamentos,
      ),
      _Stat(
        label: "Por vencer",
        value: _loadingInvent || _loadingResumen ? "..." : _porVencerCount.toString(),
    ...
    final tips = <_Tip>[
      ...
      _Tip(
        ...
        icon: isAdmin ? Icons.admin_panel_settings_rounded : Icons.receipt_long_rounded,
      ),
    ];
        ...
        builder: (context, _) {
          ...
          return Stack(
            children: [
              ...
              _glowBlob(x: 0.15 + (v * 0.03), y: 0.16, size: 280, opacity: 0.18),
              _glowBlob(x: 0.85 - (v * 0.03), y: 0.22, size: 240, opacity: 0.14),
                    ...
                    child: ConstrainedBox(
                      ...
                      child: FadeTransition(
                        ...
                        child: SlideTransition(
                          position: _slide,
                          child: _glassHomeCard(v, isAdmin, stats, tips, activity),
                        ),
                      ),
                    ),
                  ),
                      ...
                      return Transform.translate(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: const Color(0xFF00B4D8).withOpacity(0.20),
                                blurRadius: 22,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          _loadingInvent
                              ? "Cargando inventario..."
                              : (_idInventActual == null ? "Sin inventario asignado" : "Inventario #$_idInventActual"),
                          style: TextStyle(
                            color: Colors.white.withOpacity(0.68),
                            fontSize: 11.5,
                            fontWeight: FontWeight.w700,
                  ...
                  return GridView.count(
                    ...
                    children: [
                      ...
                      _moduleTile(
                        ...
                        onTap: () => _msg("Movimientos: próximamente 😄"),
                      ),
                      if (isAdmin)
                        _moduleTile(
                          title: "Panel Control",
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(tip.icon, color: const Color(0xFF00B4D8), size: 24),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: Column(
...
class _Activity {
  ...
  final IconData icon;
  const _Activity({required this.title, required this.subtitle, required this.icon});
}
...
class _PorVencerItem {
  ...
  factory _PorVencerItem.fromMap(Map<String, dynamic> map) {
    return _PorVencerItem(
      nombre: (map['nombre_medicamento'] ?? '').toString(),
