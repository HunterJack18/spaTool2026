    ...
    setState(() {
      if (query.isEmpty) {
        ...
        itemsFiltrados = items.where((item) {
          final nombre = item['sku_item'].toString().toLowerCase();
          final category = item['codbar_item'].toString().toLowerCase();
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          onPressed: () {
                            //AgregarInventario();
                            mostrarMensaje("Agregar item no esta listo");
                          },
                        ),
                      ),
                    ],
